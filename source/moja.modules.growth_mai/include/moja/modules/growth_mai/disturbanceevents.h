...
class GROWTH_MAI_API DisturbanceEventHandler {
  public:
   virtual ~DisturbanceEventHandler() {}

   virtual void simulate(const PlantEvent& plant) {}
   virtual void simulate(const ClearEvent& clear) {}
};

class GROWTH_MAI_API DisturbanceEventBase : public flint::EventBase {
  public:
...
class GROWTH_MAI_API DisturbanceEventsList {
  public:
