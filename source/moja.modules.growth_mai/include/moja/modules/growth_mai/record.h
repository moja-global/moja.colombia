...
// --------------------------------------------------------------------------------------------
// id, localdomainid, date id, locn id, flux type id, itemCount, src pool id, dst pool id, flux value
typedef Poco::Tuple<Int64, int, Int64, Int64, Poco::Nullable<Int64>, Int64, Int64, double, int> FluxRow;
struct FluxKey {
...
inline bool FluxKey::operator==(const FluxKey& other) const {
   return _sinkPoolInfoId == other._sinkPoolInfoId && _srcPoolInfoId == other._srcPoolInfoId &&
          ...
          _localDomainId == other._localDomainId;
}
...
typedef Poco::Tuple<Int64, int, Int64, Int64, Int64, double, int> StockRow;
struct StockKey {
   short _localDomainId;
   short _dateId;
   int _locationId;
...
struct StockRecordConverter {
   static StockRow asPersistable(const StockKey& key, const StockValue& value) {
      return StockRow{value._id,   key._localDomainId, key._dateId,     key._locationId,
                      key._poolId, value._value,       value._itemCount};
   }
};
